...
label = Label(root, text="Internet Speed Test", font=(
    "Lucida Sans Unicode", 20, "bold", "italic"), fg="#5D6D7E", bg="#dee8f1")
label.place(relx=0.5, rely=0.1, anchor=CENTER)

label_download = Label(root, text="Download Speed ↓", font=(
    "Segoe Print", 18, "bold", "italic"), fg="#1E8449", bg="#dee8f1")
label_download.place(relx=0.75, rely=0.5, anchor=CENTER)

label_upload = Label(root, text="Upload Speed ↑", font=(
    "Segoe Print", 18, "bold", "italic"), fg="#1E8449", bg="#dee8f1")
label_upload.place(relx=0.15, rely=0.5, anchor=CENTER)
